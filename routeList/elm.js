	...
	function (msg, model) {
		...
		return {
			...
			_0: _elm_lang$core$Native_Utils.update(
				model,
				{
					lastMsg: _elm_lang$core$Basics$toString(msg)
				}),
...
var _user$project$Main$DeleteRoute = {ctor: 'DeleteRoute'};

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Main.Msg":{"args":[],"tags":{"DeleteRoute":[]}}},"aliases":{},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
