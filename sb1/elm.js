...
var _user$project$Main$viewValidation = function (model) {
	var _p1 = (_elm_lang$core$Native_Utils.eq(model.password, model.passwordAgain) && (!_elm_lang$core$Native_Utils.eq(model.password, ''))) ? {ctor: '_Tuple2', _0: 'green', _1: 'OK'} : {ctor: '_Tuple2', _0: '', _1: ''};
	var color = _p1._0;
	var message = _p1._1;
	return A2(
...
var _user$project$Main$doubleBreak = A2(
	_elm_lang$html$Html$div,
	{ctor: '[]'},
	{
		ctor: '::',
...
var _user$project$Main$Model = F4(
	function (a, b, c, d) {
		return {name: a, password: b, passwordAgain: c, passwordsMatch: d};
	});
var _user$project$Main$model = A4(_user$project$Main$Model, '', '', '', false);
...
var _user$project$Main$view = function (model) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_1: {
				ctor: '::',
				_0: _user$project$Main$doubleBreak,
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$input,
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Main.Msg":{"args":[],"tags":{"PasswordAgain":["String"],"Name":["String"],"Password":["String"]}}},"aliases":{},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
